  ...
  return (
    <main className='w-full bg-stone-950 text-slate-200'>
      ...
      <section className="w-full">
        ...
        >
          <SwiperSlide>
            <Link to=""><img src="/image/shop/slider-01.webp" alt="" className=""/></Link>
          </SwiperSlide>
          <SwiperSlide>
            <Link to=""><img src="/image/shop/slider-02.webp" alt="" className=""/></Link>
          </SwiperSlide>
          <SwiperSlide>
            <Link to=""><img src="/image/shop/slider-03.webp" alt="" className=""/></Link>
          </SwiperSlide>
      ...
      <section className="relative text-white font-light mx-auto w-11/12 py-16">
        ...
        >
          <SwiperSlide>
            <Link to=""><img src="/image/shop/category/01.webp" alt="" className="" /></Link>
            <span className="absolute bottom-5 font-medium left-1/2 -translate-x-1/2">Activeman</span>
          </SwiperSlide>
          <SwiperSlide>
            <Link to=""><img src="/image/shop/category/02.webp" alt="" className="" /></Link>
            <span className="absolute bottom-5 font-medium left-1/2 -translate-x-1/2">Avenger</span>
          </SwiperSlide>
          <SwiperSlide>
            <Link to=""><img src="/image/shop/category/03.webp" alt="" className="" /></Link>
            <span className="absolute bottom-5 font-medium left-1/2 -translate-x-1/2">Disney World</span>
          </SwiperSlide>
          <SwiperSlide>
            <Link to=""><img src="/image/shop/category/04.webp" alt="" className="" /></Link>
            <span className="absolute bottom-5 font-medium left-1/2 -translate-x-1/2">Galaxy Haven</span>
          </SwiperSlide>
          <SwiperSlide>
            <Link to=""><img src="/image/shop/category/05.webp" alt="" className="" /></Link>
            <span className="absolute bottom-5 font-medium left-1/2 -translate-x-1/2">Ghost Spider</span>
          </SwiperSlide>
          <SwiperSlide>
            <Link to=""><img src="/image/shop/category/06.webp" alt="" className="" /></Link>
            <span className="absolute bottom-5 font-medium left-1/2 -translate-x-1/2">Disney World</span>
          </SwiperSlide>
          <SwiperSlide>
            <Link to=""><img src="/image/shop/category/07.webp" alt="" className="" /></Link>
            <span className="absolute bottom-5 font-medium left-1/2 -translate-x-1/2">Avenger</span>
          </SwiperSlide>
          <SwiperSlide>
            <Link to=""><img src="/image/shop/category/08.webp" alt="" className="" /></Link>
            <span className="absolute bottom-5 font-medium left-1/2 -translate-x-1/2">Avenger</span>
          </SwiperSlide>
          <SwiperSlide>
            <Link to=""><img src="/image/shop/category/09.webp" alt="" className="" /></Link>
            <span className="absolute bottom-5 font-medium left-1/2 -translate-x-1/2">Avenger</span>
          </SwiperSlide>
          <SwiperSlide>
            <Link to=""><img src="/image/shop/category/10.webp" alt="" className="" /></Link>
            <span className="absolute bottom-5 font-medium left-1/2 -translate-x-1/2">Avenger</span>
          </SwiperSlide>
          <div className="navigation_">
            <div className="swiper-button-prev hover-bg-red"><FontAwesomeIcon icon={faChevronLeft} style={{color: "#fafafa",}} /></div>
        ...
        <div className="merchandise-grid">
            <div className="merchandise-grid-1 mercha-hover">
                <Link to="">
                    ...
                    <div className="mercha-hover-img"><img src="/image/shop/card/01.webp" alt="" className="merchandise-grid-img"/></div>
                </Link>
            </div>
            <div className="merchandise-grid-2 mercha-hover">
                <Link to="">
                    ...
                    <div className="mercha-hover-img"><img src="/image/shop/card/02.webp" alt="" className="merchandise-grid-img"/></div>
                </Link>
            </div>
            <div className="merchandise-grid-3 mercha-hover">
                <Link to="">
                    ...
                    <div className="mercha-hover-img-mid"><img src="/image/shop/card/03.webp" alt="" className="merchandise-grid-img-mid"/></div>
                </Link>
            </div>
            <div className="merchandise-grid-4 mercha-hover">
                <Link to="">
                    ...
                    <div className="mercha-hover-img"><img src="/image/shop/card/04.webp" alt="" className="merchandise-grid-img"/></div>
                </Link>
            </div>
            <div className="merchandise-grid-5 mercha-hover">
                <Link to="">
                    ...
                    <div className="mercha-hover-img"><img src="/image/shop/card/05.webp" alt="" className="merchandise-grid-img"/></div>
                </Link>
            </div>
        </div>
      </section>
      ...
      <section className="relative text-slate-200 font-medium mx-auto w-11/12 mt-16">
        ...
        >
          <SwiperSlide>
            <div className=" mercha-sec4">
              <div className="relative">
                  <Link to=""><img src="/image/shop/product/01.webp" alt="" className=""/></Link>
          ...
          <SwiperSlide>
            <div className=" mercha-sec4">
              <div className="relative">
                  <Link to=""><img src="/image/shop/product/02.webp" alt="" className=""/></Link>
                  <div className="mercha-sec4-hover-item netflix-bg"><FontAwesomeIcon icon={faEye} /><FontAwesomeIcon icon={faHeart} /><FontAwesomeIcon icon={faTrashCan} /></div>
              </div>
              <div className="flex flex-col items-center mt-4">
                  <p>Black Bow</p>
          ...
          <SwiperSlide>
            <div className=" mercha-sec4">
              <div className="relative">
                  <Link to=""><img src="/image/shop/product/03.webp" alt="" className=""/></Link>
                  <div className="mercha-sec4-hover-item netflix-bg"><FontAwesomeIcon icon={faEye} /><FontAwesomeIcon icon={faHeart} /><FontAwesomeIcon icon={faTrashCan} /></div>
              </div>
          ...
          <SwiperSlide>
            <div className=" mercha-sec4">
              <div className="relative">
                  <Link to=""><img src="/image/shop/product/04.webp" alt="" className=""/></Link>
                  <div className="mercha-sec4-hover-item netflix-bg"><FontAwesomeIcon icon={faEye} /><FontAwesomeIcon icon={faHeart} /><FontAwesomeIcon icon={faTrashCan} /></div>
              </div>
              <span className="absolute top-3 font-medium left-3 netflix-bg px-2 py-0.5">sale!</span>
              <div className="flex flex-col items-center mt-4">
          ...
          <SwiperSlide>
            <div className=" mercha-sec4">
              <div className="relative">
                  <Link to=""><img src="/image/shop/product/05.webp" alt="" className=""/></Link>
                  <div className="mercha-sec4-hover-item netflix-bg"><FontAwesomeIcon icon={faEye} /><FontAwesomeIcon icon={faHeart} /><FontAwesomeIcon icon={faTrashCan} /></div>
              </div>
              <div className="flex flex-col items-center mt-4">
                  <p>Black Bow</p>
      ...
      <section>
        <div className="w-11/12 mx-auto flex flex-col md:flex-row md:gap-3">
            <div className="mt-28">
                <img src="/image/shop/card/capton-america.webp" alt=""/>
                <div>
            ...
            <div>
                <img src="/image/shop/card/deadpool.webp" alt=""/>
                <div>
        ...
        <div className="w-full h-auto mt-10 bg-[url('/image/shop/card/bg-img.webp')]">
            <img src="/image/shop/card/multipal.webp" alt=""/>
            <div className="p-5">
      ...
      <section className="mt-16 flex flex-col lg:flex-row">
        ...
        <div className="bg-[url('/image/shop/card/location.webp')] lg:flex-1 w-full h-80 lg:h-96 bg-cover"></div>
      </section>
    </main>
  )
}
