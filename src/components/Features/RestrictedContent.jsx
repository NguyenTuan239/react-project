...
const RestrictedContent = () => {
  ...
  return (
    <main className=" w-full bg-stone-950 text-slate-200 pt-14 md:pt-16">
      ...
      <section className="video-container bg-stone-800 w-11/12 mx-auto flex items-center justify-center">
        <div className="flex flex-col gap-3 justify-center items-center">
            <p>You must be logged in to view this content.</p>
            <a href="#"><div className="sub-but my-2 w-48 h-12 text-sm font-bold"><span className="sub-bg netflix-bg rounded-md"></span><span className="sub-but1"></span><span className="sub-but2"></span><span className="sub-but-text">Subscribr to watch<FontAwesomeIcon icon={faCaretRight} size='lg' className='pl-2' /></span></div></a>
            <p>Already a Member?</p>
            <a href="#"><div className="sub-but my-2 w-36 h-12 text-sm font-bold"><span className="sub-bg netflix-bg rounded-md"></span><span className="sub-but1"></span><span className="sub-but2"></span><span className="sub-but-text">log in<FontAwesomeIcon icon={faCaretRight} size='lg' className='pl-2' /></span></div></a>
        </div>
      </section>
      {/* section 2 Video description  */}
      <section className="p-4 flex flex-col md:flex-row md:justify-between xl:px-28">
      <div>
        <h2 className="text-3xl font-semibold movie-poster-hl md:text-7xl">The Avenger</h2>
